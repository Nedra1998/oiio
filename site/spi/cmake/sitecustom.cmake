...
if (${PROJ_NAME}_SPIREZ)
    ...
    configure_file ("${PROJECT_SOURCE_DIR}/site/spi/rez/package.py.in" "${OIIO_BINARY_DIR}/package.py")

    set (appcfg_filename "${OIIO_BINARY_DIR}/${PROJECT_NAME}_${PROJECT_VERSION_MAJOR}.${PROJECT_VERSION_MINOR}.${PROJECT_VERSION_PATCH}.${PROJECT_VERSION_TWEAK}.xml")
    configure_file ("${PROJECT_SOURCE_DIR}/site/spi/appcfg.xml.in" "${appcfg_filename}")

    install (FILES ${OIIO_BINARY_DIR}/package.py
